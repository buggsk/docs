...
## Tracking
All tracking status events are stored in the Orchestro database using a network standard code structure. Carrier Participants are encouraged to adopt these codes as described in an Appendix to this document.  
...
Tracking status events are distributed to network members for consumption using the Orchestro standard codes. They are provided in an Appendix to this document. The Orchestro integration team will assist as needed with this process. 
