...
description: ''
---
SFTP enables the exchange of manifest data in both directions using CSV files. Orchestro can accommodate and handle files in the preferred format of the carrier. Orchestro recommends using the universal manifest file format. To obtain a sample of the latest manifest version in CSV format, carriers should contact Orchestro carrier.integration@orchestro.ai.
